...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="relative inline-flex h-10 w-20 items-center rounded-full transition-colors" style={{ backgroundColor: "#515151" }}>
        <div className="absolute left-1 flex h-8 w-8 items-center justify-center rounded-full transition-transform" style={{ backgroundColor: "#3636FF" }}>
